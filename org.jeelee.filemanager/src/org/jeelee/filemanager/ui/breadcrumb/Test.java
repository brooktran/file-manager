...
public class Test {
	...
	protected void createContents() {
		...
		combo_2.setItems(new String[] {"3423", "4234200000", "34"});
		combo_2.setBackground(SWTResourceManager.getColor(SWT.COLOR_LIST_BACKGROUND));
		combo_2.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		combo_2.setText("00000000");
		...
		link_1.setBackground(SWTResourceManager.getColor(SWT.COLOR_LIST_BACKGROUND));
		link_1.setText("<a>New Link</a>");
		
		ComboViewer comboViewer = new ComboViewer(composite, SWT.READ_ONLY);
		Combo combo_1 = comboViewer.getCombo();
		combo_1.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		combo_1.setText("0000");
