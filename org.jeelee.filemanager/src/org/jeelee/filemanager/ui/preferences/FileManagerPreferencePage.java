...
public class FileManagerPreferencePage extends PreferencePage {
	...
	private static enum EasyShellCommand {
		cmdUnknown(0, "Unknown shell / file browser", "open {1}",
				"cd {1} && run {3}", "explore {2}", "{2}{5}"), cmdWinDOS(1,
				...
				"explorer.exe /select,\"{2}\"", "{2}{5}"), cmdWinCyg(3,
				...
				"konqueror file:{2}", "{2}{5}"), cmdKonsoleGnome(5,
				...
				"cd {1} && open {3}", "open -a Finder {2}", "{2}{5}"), cmdKonsoleKDEDolphin(
