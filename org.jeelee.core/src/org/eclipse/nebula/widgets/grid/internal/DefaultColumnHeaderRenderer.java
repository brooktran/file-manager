...
public class DefaultColumnHeaderRenderer extends GridHeaderRenderer {
	...
	private AbstractRenderer arrowRenderer;

	private TextLayout textLayout;

	public DefaultColumnHeaderRenderer(Grid grid) {
		super(grid);
		arrowRenderer = new SortArrowRenderer(grid);
	}
	
	public void setArrowRenderer(AbstractRenderer arrowRenderer) {
	...
	public void paint(GC gc, Object value) {
		LightGridColumn column = (LightGridColumn) value;
		...
		if (column.getAlignment() == SWT.RIGHT) {//SWT.TRAIL
