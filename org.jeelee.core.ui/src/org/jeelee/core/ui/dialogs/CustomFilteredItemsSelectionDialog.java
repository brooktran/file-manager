package org.jeelee.core.ui.dialogs;
...
import org.jeelee.core.ui.dialogs.CustomFilteredItemsSelectionDialog.AbstractContentProvider;
import org.jeelee.core.ui.dialogs.CustomFilteredItemsSelectionDialog.ItemsFilter;
import org.jeelee.core.ui.dialogs.CustomFilteredItemsSelectionDialog.SelectionHistory;

/**
 * <B>CustomFilteredItemsSelectionDialog</B>
 * 
 *  
 * @author Brook Tran. Email: <a href="mailto:Brook.Tran.C@gmail.com">Brook.Tran.C@gmail.com</a>
 * @version Ver 1.0.01 Jun 6, 2012 created
 * @since org.jeelee.core.ui Ver 1.0
 * 
...
public abstract class CustomFilteredItemsSelectionDialog extends SelectionStatusDialog{
	...
	protected ItemsListLabelProvider itemsListLabelProvider;
	 ...
	 */
	protected ItemsListLabelProvider getItemsListLabelProvider() {
	...
	protected Control createDialogArea(Composite parent) {
		...
		list = createList(content, listLabel);
	...
	protected TableViewer createList(Composite content, final Label listLabel) {
		GridData gd;
	...
	private class RefreshJob extends UIJob {
		 ...
		 */
		public RefreshJob() {
			super(CustomFilteredItemsSelectionDialog.this.getParentShell()
					.getDisplay(),
	...
	private class RefreshProgressMessageJob extends UIJob {
		...
		public RefreshProgressMessageJob() {
			super(
					CustomFilteredItemsSelectionDialog.this.getParentShell()
							.getDisplay(),
		...
		protected IStatus run(IProgressMonitor monitor) {
			...
			if (CustomFilteredItemsSelectionDialog.this != null) {
				GranualProgressMonitor wrappedMonitor = new GranualProgressMonitor(
						monitor);
				CustomFilteredItemsSelectionDialog.this.reloadCache(true,
						wrappedMonitor);
			}
	...
	protected class ItemsListLabelProvider extends StyledCellLabelProvider
		...
		public void update(ViewerCell cell) {
			...
			if (!(element instanceof ItemsListSeparator)
				...
				cell.setText(((ITableLabelProvider)provider).getColumnText(element, index));
				cell.setImage(((ITableLabelProvider)provider).getColumnImage(element, index));
			}else {
	...
	private class ContentProvider extends AbstractContentProvider implements
		...
		public void updateElement(int index) {
			...
			CustomFilteredItemsSelectionDialog.this.list.replace((lastFilteredItems
